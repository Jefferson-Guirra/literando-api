...
import { makeResetPasswordAccountController } from '../factories/account/reset-password/reset-password-account-controller-factory'
...
const accountRouter = (router: Router): void => {
  ...
  router.put('/reset-password', adaptRoute(makeResetPasswordAccountController()))
